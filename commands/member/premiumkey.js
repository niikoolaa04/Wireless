...
module.exports = class PremiumKey extends Command {
  ...
  async slashRun(interaction, args) {
    ...
    if(generated == limit) return interaction.reply({ embeds: [ this.client.embedBuilder(this.client, interaction.user, `Error`, `You have already generated key.`, "RED")], ephemeral: true });
